...
public class Home extends Fragment implements RecyclerViewInterface {
    ...
    private String[] applianceHeading;
    ...
    private void dataInitialize() {
        ...
        for (int i =0; i< applianceHeading.length; i++){

            Appliance appliance = new Appliance(applianceHeading[i], imageResourceID[i]);
